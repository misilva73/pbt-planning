...
ROWS = [
    ...
    ("bar", "A-S1", "A-S1  EIP-8297 spec convergence", "specs", 1, 5),
    ("bar", "A-S2", "A-S2  Hash-function selection", "specs", 1, 8),
    ("bar", "A-S3", "A-S3  Witness-gas recalibration", "specs", 4, 10),
    ("bar", "A-S4", "A-S4  EIP-8297 spec freeze", "specs", 9, 12),
    ...
    ("bar", "B-S1", "B-S1  EIP-7748 → PBT adaptation", "specs", 2, 8),
    ("bar", "B-S2", "B-S2  Preimage & snapshot manifest", "specs", 3, 7),
    ("bar", "B-S3", "B-S3  BAL-replay spec", "specs", 5, 10),
    ...
    ("bar", "B-C5", "B-C5  Testnet migrations + shadow fork", "clients", 14, 19),
    ("bar", "B-C6", "B-C6  Mainnet window (block N)", "clients", 19, 24),
...
DETAIL = {
    ...
    "A-S2": "A-S2-hash-function-selection.md",
    ...
    "B-S1": "B-S1-eip7748-adaptation.md",

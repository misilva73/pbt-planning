...
ROWS = [
    ...
    ("bar", "A-S2", "A-S2  Gas cost recalibration", "specs", 19, 21),
    ("bar", "A-S3", "A-S3  EIP-8297 spec freeze", "specs", 7, 9),
    ...
    ("bar", "B-S1", "B-S1  Offline-migration EIP", "specs", 1, 6),
    ("bar", "B-S2", "B-S2  Readiness gate & activation", "specs", 15, 20),
...
DETAIL = {
    ...
    "A-S3": "A-S3-eip8297-spec-freeze.md",

...
| Series | Total events |
| --- | --- |
| `is_tx_touched` | 25,263,200 |
| `is_block_touched` | 18,782,534 |
| `is_tx_write` | 8,929,303 |
| `is_block_write` / `is_block_write_with_account` | 8,016,205 |
...
| --- | --- | --- | --- |
| is_tx_touched | 0.0% | 30.2% | 31.4% |
| is_block_touched | 0.0% | 20.3% | 21.7% |
...
| tx_write_keys_all_observed_as_reads | n_tx_write_keys=8929303; n_uncovered=0; holds=True |
| block_write_keys_all_observed_as_reads | n_block_write_keys=8016205; n_uncovered=0; holds=True |
